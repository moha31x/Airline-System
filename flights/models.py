...
class Staff(models.Model):
    ...
    flight_no = models.ManyToManyField(Flight, blank=True, related_name='staffs')
...
class Passenger(models.Model):
    ...
    flight_no = models.ForeignKey(Flight, on_delete=models.CASCADE, default=1007, related_name='passengers')
    checked_in_status = models.BooleanField(default=0)
    booked_by = models.ForeignKey(User, on_delete=models.CASCADE, default='moha')
